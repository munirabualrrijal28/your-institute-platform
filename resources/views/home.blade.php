...
<!-- Hero Section -->
<div class="bg-teal-600 text-white text-center py-8 text-color">
    <h1 class="text-white font-bold">Welcome In Your Institute</h1>
</div>
...
{{-- <div class="bg-white shadow p-6 flex flex-col md:flex-row items-center justify-between">
    <div class="flex gap-4 items-center w-full md:w-1/2">
        <input type="text" placeholder="Search For Anything" class="w-full px-4 py-2 border rounded-md" />
        <button class="bg-gray-700 text-white px-4 py-2 rounded-md">Log In</button>
        <button class="bg-gray-500 text-white px-4 py-2 rounded-md">Sign Up</button>
    </div>
</div> --}}
<!-- Categories Navigation -->
{{-- <div class="flex justify-center gap-6 border-b pb-4 text-gray-700 font-medium">
    <a href="#">English</a>
    <a href="#" class="text-teal-600 border-b-2 border-teal-600">Programming</a>
    <a href="#">Design</a>
    <a href="#">Computer</a>
    <a href="#">Accounting</a>
</div> --}}
  ...
  {{-- <ul class="flex space-x-4 list-none p-0 m-0">
    @foreach($catagories as $category)
        <li>
            <a href="{{ $category['name'] ?? '#' }}" class="px-3 py-2 text-gray-800 rounded hover:bg-gray-100 transition">
                {{ $category['text'] }}
            </a>
        </li>
    @endforeach
