<div x-data="{ enableReset: false, showConfirm: false, showPassword: false, showSuccess: false, password: '' }">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <form action="{{ route('settings_updateInstituteName') }}" method="POST" enctype="multipart/form-data"
            class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-2xl shadow-md flex flex-col justify-between">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md space-y-4">
                    <h3 class="text-xl font-bold text-gray-800">👤 Update Institute Name</h3>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md space-y-4">
                    ...
                    <div class="flex items-center space-x-4 rtl:space-x-reverse">
                        <img id="preview"
                            src="{{ $institute?->ins_profile_photo? asset('storage/' . $institute->ins_profile_photo) : '/images/profile/user_ic.svg' }}"
        ...
        <div class="bg-white p-6 rounded-2xl shadow-md">
            ...
            <form method="POST" action="{{ route('settings_updateInstitutePassword') }}" x-show="enableReset"
        ...
        <div x-show="showPassword" x-cloak
            ...
            <div class="bg-white p-6 rounded-xl shadow-xl w-full max-w-sm animate-scale-in">
                ...
                <form method="POST" action="{{ route('settings_deleteInstituteAccount') }}">
                    @csrf
                    @method('DELETE')
