<div class="space-y-6 ltr px-4 sm:px-6 lg:px-8" dir="ltr">
    ...
    {{-- ✅ Flash Message --}}
      ...
      @if (session('message'))
            ...
            @endif
    {{-- ✅ Add/Edit Form --}}
    <div class="bg-white rounded-2xl p-4 sm:p-6 shadow-md space-y-4 border border-gray-100">
        ...
        <form wire:submit.prevent="saveInstructor" wire:key="form-{{ $formKey }}" class="space-y-4">
            ...
            <div>
                ...
                <textarea wire:model.defer="bio"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-green-400 focus:outline-none resize-none min-h-[100px]"
                    required></textarea>
                @error('bio')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <input type="file" wire:model="photo" class="w-full text-sm" />
                @if ($photo)
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach ($instructors as $instructor)
            <div
                class="bg-white rounded-xl shadow p-4 flex flex-col items-center text-center sm:text-right space-y-4 transition hover:shadow-lg">
                ...
                @if (!($editing && $instructorId === $instructor->id))
                    <div class="flex justify-center sm:justify-end w-full gap-4 pt-2 border-t border-gray-200">
