...
//     ])->to('course-comments.comment-count');
  // 🛡 Save the related model BEFORE deleting
    ...
    $this->dispatch('comment-deleted', [
        'deletedCount' => $totalDeleted,
        'deletedId' => $this->comment->id,
    ])->to('student-tabs.course-comments.course-comments');
    ...
    $this->dispatch('set-comment-count', [
        'newCount' => $newCount,
    ])->to('student-tabs.course-comments.comment-count');
    ...
    {
        return view('livewire.student-tabs.course-comments.comment-item');
    }
