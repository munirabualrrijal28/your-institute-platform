...
namespace App\Livewire\StudentTabs\CourseComments;
...
// dd('Reached notification logic', Auth::id(), Auth::user()->name);
...
//
        ...
        $this->dispatch('set-comment-count', ['newCount' => $newCount])->to('student-tabs.course-comments.comment-count');
    ...
    public function render()
    {
        ...
        return view('livewire.student-tabs.course-comments.course-comments', [
            'comments' => $comments,
