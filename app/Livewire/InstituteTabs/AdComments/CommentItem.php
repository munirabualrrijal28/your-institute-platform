...
//     ])->to('ad-comments.comment-count');
  // 🛡 Save the related model BEFORE deleting
    ...
    $this->dispatch('comment-deleted', [
        'deletedCount' => $totalDeleted,
        'deletedId' => $this->comment->id,
    ])->to('institute-tabs.ad-comments.ad-comments');
    ...
    $this->dispatch('set-comment-count', [
        'newCount' => $newCount,
    ])->to('institute-tabs.ad-comments.comment-count');
    ...
    {
        return view('livewire.institute-tabs.ad-comments.comment-item');
    }
