...
class AdComments extends Component
{
    ...
    public function postComment()
    {
        ...
        $this->dispatch('set-comment-count', ['newCount' => $newCount])->to('institute-tabs.ad-comments.comment-count');
    ...
    public function render()
    {
        ...
        return view('livewire.institute-tabs.ad-comments.ad-comments', [
            'comments' => $comments,
